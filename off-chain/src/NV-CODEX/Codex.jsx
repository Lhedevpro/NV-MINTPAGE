...
function Codex() {
    ...
    useEffect(() => {
        const checkPendingSignatures = async () => {
            if (account) {
                try {
                    const response = await axios.get('https://api-codex-h76c.onrender.com/mission/results');
    ...
    const handleMissionClick = async (mission) => {
        ...
        try {
            ...
            const pendingResponse = await axios.get('https://api-codex-h76c.onrender.com/mission/results');
    ...
    const handlePendingMission = async (mission) => {
        try {
            ...
            try {
                ...
                try {
                    await axios.delete(`https://api-codex-h76c.onrender.com/mission/results/${mission.missionId}`);
    ...
    const handleSignature = async () => {
        ...
        try {
            ...
            try {
                const response = await axios.post('https://api-codex-h76c.onrender.com/mission/commit', {
                    address: account,
                ...
                if (response.data.success) {
                    ...
                    if (results) {
                        // Supprimer l'enregistrement de la mission
                        try {
                            await axios.delete(`https://api-codex-h76c.onrender.com/mission/results/${savedMissionResults.missionId}`);
                            console.log('Enregistrement de la mission supprimé');
                        } catch (error) {
                            console.error('Erreur lors de la suppression de l\'enregistrement:', error);
                        }
    ...
    const handleStatSelection = async (statIndex) => {
        ...
        try {
            ...
            const response = await axios.post('https://api-codex-h76c.onrender.com/mission/resolve', {
                address: account,
                heroId: Number(heroStats.tokenId),
            ...
            const missionResponse = await axios.get('https://api-codex-h76c.onrender.com/mission/missions');
            ...
            try {
                ...
                // Supprimer l'enregistrement de la mission
                try {
                    await axios.delete(`https://api-codex-h76c.onrender.com/mission/results/${selectedMission.id}`);
                    console.log('Enregistrement de la mission supprimé');
                } catch (error) {
                    console.error('Erreur lors de la suppression de l\'enregistrement:', error);
                }
